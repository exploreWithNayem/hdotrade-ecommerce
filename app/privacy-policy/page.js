export default function page() {
  return (
    <div className="mt-10">
      **Privacy Policy** Last updated: [Insert Date] LwsKart we operates
      https://lwskart-black.vercel.app the Site. This page informs you of our
      ...
      policy. **Information Collection and Use** While using our Site, we may
      ...
      postal address, and phone number Personal Information **Log Data** Like
      many site operators, we collect information that your browser sends
      whenever you visit our Site Log Data. This Log Data may include
      information such as your computers Internet Protocol IP address, browser
      type, browser version, the pages of our Site that you visit, the time and
      ...
      **Cookies** Cookies are files with a small amount of data, which may
      ...
      from a web site and stored on your computer hard drive. Like many sites,
      ...
      to us, but remember that no method of transmission over the Internet, or
      method of electronic storage, is 100% secure. While we strive to use
      commercially acceptable means to protect your Personal Information, we
      cannot guarantee its absolute security. **Changes to This Privacy Policy**
      This Privacy Policy is effective as of and will remain in effect except
      with respect to any changes in its provisions in the future, which will be
      ...
      check this Privacy Policy periodically. Your continued use of the Service
      ...
      our website. **Contact Us** If you have any questions about this Privacy
      Policy, please contact us at naeemislam13790@gmail.com
    </div>
  );
}
